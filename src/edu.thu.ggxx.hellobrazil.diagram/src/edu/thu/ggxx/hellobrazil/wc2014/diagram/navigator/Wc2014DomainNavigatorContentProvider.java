 ...
 * @generated
 */
public class Wc2014DomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Wc2014DomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Wc2014DomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Wc2014DomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Wc2014DomainNavigatorItem((EObject) objects[i],
