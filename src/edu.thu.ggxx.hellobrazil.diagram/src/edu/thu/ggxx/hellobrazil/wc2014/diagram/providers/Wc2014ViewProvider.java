 ...
 * @generated
 */
public class Wc2014ViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return WorldCupEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(WorldCupEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = Wc2014VisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = Wc2014VisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case EliminationMatchEditPart.VISUAL_ID:
			return createEliminationMatch_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case TeamEditPart.VISUAL_ID:
			return createTeam_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case GroupEditPart.VISUAL_ID:
			return createGroup_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case GroupMatchEditPart.VISUAL_ID:
			return createGroupMatch_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (Wc2014VisualIDRegistry.getVisualID(elementTypeHint)) {
		case GroupFirstTeamEditPart.VISUAL_ID:
			return createGroupFirstTeam_4001(containerView, index, persisted,
					preferencesHint);
		case MatchHomeEditPart.VISUAL_ID:
			return createMatchHome_4002(containerView, index, persisted,
					preferencesHint);
		case GroupSecondTeamEditPart.VISUAL_ID:
			return createGroupSecondTeam_4003(containerView, index, persisted,
					preferencesHint);
		case MatchAwayEditPart.VISUAL_ID:
			return createMatchAway_4004(containerView, index, persisted,
					preferencesHint);
		case TeamAtGroupEditPart.VISUAL_ID:
			return createTeamAtGroup_4005(containerView, index, persisted,
					preferencesHint);
		case EliminationMatchWinnerEditPart.VISUAL_ID:
			return createEliminationMatchWinner_4006(containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createTeam_2002(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Wc2014VisualIDRegistry.getType(TeamEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createGroup_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Wc2014VisualIDRegistry.getType(GroupEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createGroupMatch_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!WorldCupEditPart.MODEL_ID.equals(Wc2014VisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", WorldCupEditPart.MODEL_ID); //$NON-NLS-1$
