 ...
 * @generated
 */
public class TeamCountryEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TeamCountryEditPart(View view) {
		super(view);
	}
			...
			parser = Wc2014ParserProvider
					.getParser(
							...
							Wc2014VisualIDRegistry
									.getType(edu.thu.ggxx.hellobrazil.wc2014.diagram.edit.parts.TeamCountryEditPart.VISUAL_ID));
		}
		return parser;
	}
