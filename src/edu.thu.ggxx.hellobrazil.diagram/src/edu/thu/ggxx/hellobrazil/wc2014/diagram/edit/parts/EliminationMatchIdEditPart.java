...
import edu.thu.ggxx.hellobrazil.wc2014.diagram.edit.policies.Wc2014TextSelectionEditPolicy;
 ...
 * @generated
 */
public class EliminationMatchIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EliminationMatchIdEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new Wc2014TextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return Wc2014ElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Wc2014ParserProvider
					.getParser(
							Wc2014ElementTypes.EliminationMatch_2001,
							getParserElement(),
							Wc2014VisualIDRegistry
									.getType(edu.thu.ggxx.hellobrazil.wc2014.diagram.edit.parts.EliminationMatchIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					Wc2014EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
