 ...
 * @generated
 */
public class EliminationMatchWinnerCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EliminationMatchWinnerCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof EliminationMatch) {
			return false;
		}
		...
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateEliminationMatchWinner_4006(getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected EliminationMatch getSource() {
		return (EliminationMatch) source;
	}
