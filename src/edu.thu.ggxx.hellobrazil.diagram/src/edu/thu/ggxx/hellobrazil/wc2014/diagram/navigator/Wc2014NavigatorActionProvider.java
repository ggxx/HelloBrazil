...
import edu.thu.ggxx.hellobrazil.wc2014.diagram.part.Wc2014DiagramEditor;
 ...
 * @generated
 */
public class Wc2014NavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof Wc2014NavigatorItem) {
					selectedElement = ((Wc2014NavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, Wc2014DiagramEditor.ID);
