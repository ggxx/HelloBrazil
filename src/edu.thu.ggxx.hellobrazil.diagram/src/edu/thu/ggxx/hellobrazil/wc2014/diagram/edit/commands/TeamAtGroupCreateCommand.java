 ...
 * @generated
 */
public class TeamAtGroupCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TeamAtGroupCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateTeamAtGroup_4005(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setAtGroup(getTarget());
		}
