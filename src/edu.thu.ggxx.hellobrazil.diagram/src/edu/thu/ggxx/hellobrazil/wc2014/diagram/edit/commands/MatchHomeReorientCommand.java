 ...
 * @generated
 */
public class MatchHomeReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MatchHomeReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMatchHome_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMatchHome_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setHome(null);
		getNewSource().setHome(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setHome(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
