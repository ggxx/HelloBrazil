 ...
 * @generated
 */
public class GroupGroupNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GroupGroupNameEditPart(View view) {
		super(view);
	}
			...
			parser = Wc2014ParserProvider
					.getParser(
							...
							Wc2014VisualIDRegistry
									.getType(edu.thu.ggxx.hellobrazil.wc2014.diagram.edit.parts.GroupGroupNameEditPart.VISUAL_ID));
		}
		return parser;
	}
