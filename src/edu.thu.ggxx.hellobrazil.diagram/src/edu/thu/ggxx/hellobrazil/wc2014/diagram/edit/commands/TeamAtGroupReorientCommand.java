 ...
 * @generated
 */
public class TeamAtGroupReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TeamAtGroupReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Group && newEnd instanceof Team)) {
			return false;
		}
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTeamAtGroup_4005(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTeamAtGroup_4005(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setAtGroup(null);
		getNewSource().setAtGroup(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setAtGroup(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
