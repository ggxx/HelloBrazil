 ...
 * @generated
 */
public class GroupSecondTeamCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GroupSecondTeamCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGroupSecondTeam_4003(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setSecondTeam(getTarget());
		}
