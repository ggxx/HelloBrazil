 ...
 * @generated
 */
public class GroupMatchIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GroupMatchIdEditPart(View view) {
		super(view);
	}
			...
			parser = Wc2014ParserProvider
					.getParser(
							...
							Wc2014VisualIDRegistry
									.getType(edu.thu.ggxx.hellobrazil.wc2014.diagram.edit.parts.GroupMatchIdEditPart.VISUAL_ID));
		}
		return parser;
	}
