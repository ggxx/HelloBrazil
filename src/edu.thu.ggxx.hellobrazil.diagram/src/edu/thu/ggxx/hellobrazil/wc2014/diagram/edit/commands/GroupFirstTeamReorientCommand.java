 ...
 * @generated
 */
public class GroupFirstTeamReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GroupFirstTeamReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGroupFirstTeam_4001(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGroupFirstTeam_4001(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setFirstTeam(null);
		getNewSource().setFirstTeam(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setFirstTeam(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
