 ...
 * @generated
 */
public class GroupFirstTeamCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GroupFirstTeamCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return Wc2014BaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGroupFirstTeam_4001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setFirstTeam(getTarget());
		}
